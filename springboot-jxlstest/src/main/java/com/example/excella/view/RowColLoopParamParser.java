...
public class RowColLoopParamParser extends ReportsTagParser<Object[]> {
     ...
     * デフォルトタグ
     */
    public static final String DEFAULT_TAG = "$RCL";
     ...
     * @param tag タグ
     */
    public RowColLoopParamParser( String tag) {
        super( tag);
    }
